import { NameException, EmailException, PhoneException, PasswordException, CiException, LastNameException } from './exceptions'
...
export class UserLastName {
    ...
    constructor(value: string) {
        ...
        if (specialCharRegex.test(value) || numCharRegex.test(value) || value === '') throw new LastNameException()
