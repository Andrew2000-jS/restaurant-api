...
export class UserCreator {
  ...
  private readonly _findUserByPhoneService: FindUserByPhoneService
  ...
  constructor(authRepository: AuthRepository) {
    ...
    this._findUserByPhoneService = new FindUserByPhoneService(this._authRepository)
  ...
  async run(user: AuthPrimitiveType): Promise<User> {
    ...
    await this._findUserByPhoneService.isAlreadyExist(newUser.phone._value)
